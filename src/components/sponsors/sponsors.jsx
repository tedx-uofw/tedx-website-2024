...
import ro from "../../assets/team-member-pics/Ro Verdeja.jpg"
      ...
      <div id="friends">
        ...
        <div className='ro-container'>
                    <div className='box'>
                        ...
                        <h3 className='ro-title'>Special Thanks to Ro Verdeja</h3>
                    </div>
                    <div className='ro-contents-ctr'>
                        <div className='ro-img-container'>
                            <img src={ro} className="ro-image"alt='Ro Picture'/>
                        </div>
