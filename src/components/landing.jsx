...
function Landing(){
    const items = [
        ...
        {name: 'JEFF NGUYEN', talk:'Finding Clarity: Navigating Your North Star', title: 'Founder @ BobaTalks', time: "2:00PM - 2:15PM"},
        {name: 'TRADITIONAL CHINESE DANCE @ UW', title: 'Performance', talk:'', time: "2:20PM - 2:35PM"},
        {name: 'ZARYA RUBIN, MD', talk:'Four Words That Can Protect You From Burnout', title: 'Functional Medicine Physician', time: "2:40PM - 2:55PM"},
        {name: 'RAFFLE DRAW 3', title: '', talk:'', time: "3:00PM - 3:15PM"},
